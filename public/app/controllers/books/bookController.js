(function(angular) {
    ...
    var injectParams = ['$scope', 'book', 'modalService', 'gravatarUrlBuilder'];

    var BookController = function ($scope, book, modalService, gravatarUrlBuilder) {
        ...
        $scope.save = function () {
            book.addBook($scope.newBook).then(onAddBookComplete, onError);
        };
    ...
    BookController.$inject = injectParams;

    angular.module('bookDb').controller('BookController', BookController);
})(window.angular);